...
echo "**** 1/9 - Make sure the /uploads folder exists ****"
mkdir -p /uploads
...
echo "**** 4/9 - Setting PHP configuration ****"
...
echo "**** 5/9 - Migrate the database ****"
cd /app/public && \
php bin/console doctrine:migrations:migrate --no-interaction --allow-no-migration

echo "**** 6/9 - Apply PUID and PGID ****"
PUID=${PUID:-1001}
PGID=${PGID:-1001}
...
echo "**** 7/9 - Set permissions on /uploads ****"
