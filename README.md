...
services:
    goshuin:
        ...
        environment:
            ...
            - PUID=1000
            - PGID=1000
            # The instance makes two outbound requests: map tiles from
            # OpenStreetMap, and the place search from a Photon instance. Photon
            # is the only geocoder this speaks to. Empty PHOTON_HOST_URL to
